...
use crate::models::{AuthError, AuthResult, User, Session, UserProfile};
...
impl AuthService {
    ...
    pub async fn register(
        ...
        let user = self.auth_repo.register(&db_guard, username, email, &password_hash).await?;
    ...
    pub async fn login(
        ...
        let user = db_guard.get_user_by_username(username).await.map_err(|_| {
    ...
    pub async fn logout(
        ...
        let db_guard = db.lock().await;
        self.auth_repo.invalidate_session(&db_guard, session_token).await
    }
    ...
    pub async fn request_password_reset(
        ...
        self.auth_repo.create_password_recovery(&db_guard, &user.id).await?;
    ...
    pub async fn reset_password(
        ...
        let recovery = self.auth_repo.get_password_recovery(&db_guard, token).await?;
        ...
        self.auth_repo.mark_password_recovery_as_used(&db_guard, token).await?;
    ...
    pub async fn update_password(
        ...
        let user = db_guard.get_user_by_id(user_id).await.map_err(|_| {
        ...
        self.auth_repo.update_user_password(&db_guard, user_id, &new_password_hash).await?;
