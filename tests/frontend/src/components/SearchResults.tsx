...
export const SearchResults = ({
  ...
  return (
    <div
      ref={dropdownRef}
      className="absolute left-0 top-full mt-2 w-96 max-h-96 overflow-y-auto rounded-lg bg-white dark:bg-gray-800 shadow-xl ring-1 ring-black ring-opacity-5 dark:ring-white dark:ring-opacity-10"
      tabIndex={-1}
