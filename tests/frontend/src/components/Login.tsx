...
export const Login = () => {
  ...
  const { login: loginFn, isAuthenticated, setUser, setToken } = useAuthStore();
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-lg dark:bg-gray-800">
        <h2 className="mb-6 text-2xl font-bold text-center text-blue-600 dark:text-blue-400">Welcome to Memos-RS</h2>
